...
export default defineNuxtConfig({
  ...
  // Prevent Nuxt/content from intercepting /admin static files
  hooks: {
    'nitro:config'(nitroConfig) {
      nitroConfig.ignore = nitroConfig.ignore || []
      nitroConfig.ignore.push('/admin/**')
    }
  },

  app: {
    head: {
      title: 'Classical Arabic with Omar',
      meta: [
        { charset: 'utf-8' },
        ...
        { property: 'og:title', content: 'Classical Arabic with Omar' },
